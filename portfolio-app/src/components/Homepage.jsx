  ...
  return (
    <>
      ...
      <div id="homepage" className="mt-10 md:flex-col-reverse items-center sm:flex-col-reverse flex-col-reverse lg:mt-10 sm:px-16 px-14 sm:pt-20 pt-16 sm:pl-16 pl-14 sm:pr-16 pr-14 sm:pb-10 pb-8 flex   lg:justify-left justify-center sm:items-center lg:flex lg:flex-row lg:items-center lg:w-full lg:justify-between lg:px-16 lg:pt-16 lg:pl-16 lg:pr-16 lg:pb-10">
        ...
        <motion.div  variants={container} animate="animate"  className="pb-5 headline flex sm:flex-col flex-col  first lg:w-3/5 lg:space-y-4  sm:space-y-2 space-y-1 sm:w-full text-black sm:mt-0">
       ...
       <motion.p variants={vari} initial="initial" animate="anima" className=' font-normal text-gray-800 text-md font-custom lg:text-gray-500 ...'>
...
<motion.div 
  ...
  initial="initial" 
  animate="anima" 
  className="btns flex flex-col sm:flex-row justify-start items-start mt-8 space-y-4 sm:space-y-0 sm:space-x-4"
>
  ...
  <Link to="contact" smooth={true} duration={700}>
    <motion.button 
      ...
      className='lg:bg-[#3C9189] bg-[#3C9189] lg:text-white text-white lg:text-md lg:px-6 lg:py-3 lg:rounded-md lg:font-custom lg:font-extrabold sm:bg-[#3C9189] sm:text-white sm:text-md sm:px-6 px-3 sm:py-3 py-2 sm:rounded-md rounded-md sm:font-custom font-custom sm:font-extrabold font-bold text-sm min-w-20'
    >
      CONTACT INFO
    </motion.button>
  </Link>
